...
load '\..\..\conceptual_blending_project\source\data.rb'
...
hapr = AtomicObjectProperty.new(hap)
...
ipr = AtomicObjectProperty.new(ip)
wpr = AtomicObjectProperty.new(wp)
...
Vc1 = AtomicConcept.new(V)
Topr = AtomicObjectProperty.new(Top)
